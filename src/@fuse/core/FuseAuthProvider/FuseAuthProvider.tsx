...
import {
  FuseAuthProviderType,
  FuseAuthProviderMethods,
  FuseAuthProviderState,
} from "./types/FuseAuthTypes";
...
function FuseAuthProvider(props: FuseAuthenticationProviderProps) {
  ...
  const currentProvider = useMemo(
    () => providerRefs.current[authState?.provider],
    [authState, providerRefs]
  );
  ...
  return (
    <FuseAuthContext value={contextValue}>{nestedProviders}</FuseAuthContext>
  );
}
