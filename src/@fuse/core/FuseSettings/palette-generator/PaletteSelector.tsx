...
function PaletteSelector(props: PaletteSelectorProps) {
  const {
    ...
    triggerElement = (
      <div className="m-2 flex w-32 flex-col items-center space-y-2">
        <SectionPreview />
        <Typography className="mb-6 flex-1 text-lg font-bold">
          Edit Palette
        </Typography>
      </div>
    ),
  ...
  const { reset, formState, trigger, handleSubmit, watch, control, setValue } =
    methods;
