...
i18next.addResourceBundle("en", "error401Page", en);
i18next.addResourceBundle("ru", "error401Page", ru);
i18next.addResourceBundle("uz", "error401Page", uz);
...
function Error401Page() {
  ...
  const { t } = useTranslation("error401Page");
